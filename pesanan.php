...
$pemesanan = query("SELECT * FROM tb_pemesanan");
?>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <h2 style="text-align: center; margin-top: 1%;"><b>Daftar Pesanan</b></h2>
        ...
        <?php foreach ($pemesanan as $row) : ?>
          <tr>
            ...
            <td><a href="detail_pesanan.php?id_pemesanan=<?= $row["id_pemesanan"]; ?>">Detail</a></td>
          </tr>
        <?php $i++; ?>
        <?php endforeach; ?>
        </tbody>
